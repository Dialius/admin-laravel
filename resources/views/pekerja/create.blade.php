...
@section('page-title', 'Tambah Data Pekerja')

@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('pekerja.index') }}">Home</a></li>
<li class="breadcrumb-item"><a href="{{ route('pekerja.index') }}">Data Pekerja</a></li>
    ...
    <div class="col-md-10 offset-md-1">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Form Tambah Data Pekerja</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('pekerja.store') }}" method="POST">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('umur') is-invalid @enderror" id="umur" name="umur" value="{{ old('umur') }}" placeholder="Min. 17">
                                @error('umur') 
                                <div class="invalid-feedback">{{ $message }}</div> 
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('nomor_hp') is-invalid @enderror" id="nomor_hp" name="nomor_hp" value="{{ old('nomor_hp') }}" placeholder="08123456789">
                                    @error('nomor_hp') 
                                    <div class="invalid-feedback">{{ $message }}</div> 
                                    @enderror
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('skill') is-invalid @enderror" id="skill" name="skill" rows="3" placeholder="Contoh: Tukang kayu, service AC, bersih-bersih, dll">{{ old('skill') }}</textarea>
                        @error('skill') 
                        <div class="invalid-feedback">{{ $message }}</div> 
                        @enderror
